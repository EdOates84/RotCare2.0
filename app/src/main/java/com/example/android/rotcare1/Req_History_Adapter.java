...
public class Req_History_Adapter extends RecyclerView.Adapter<Req_History_Adapter.MyViewHolder> {

    private Context context;
    private ArrayList<Request> Request_List;
    public String DoctorName;

    public Req_History_Adapter(Req_history_Activity c, ArrayList<Request> u) {
        context = c;
        Request_List = u;
    }
